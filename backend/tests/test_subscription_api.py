...
BASE_URL = os.environ.get('EXPO_PUBLIC_BACKEND_URL', 'https://granelli-app.preview.emergentagent.com').rstrip('/')
...
class TestSubscriptionEndpoints:
    ...
    def test_create_checkout_success(self, auth_headers):
        ...
        response = requests.post(
            f"{BASE_URL}/api/subscription/create-checkout",
            headers=auth_headers,
            json={"origin_url": "https://granelli-app.preview.emergentagent.com"}
        )
